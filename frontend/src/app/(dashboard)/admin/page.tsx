    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-1">Manage all locations, staff, and schedules from here.</p>
        </div>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="p-4 rounded-xl border border-slate-200 hover:border-blue-300 hover:bg-blue-50 transition-colors text-left">
              ...
              <p className="font-medium text-slate-900">Add Location</p>
              <p className="text-xs text-slate-500 mt-1">Create new location</p>
            </button>
            <button className="p-4 rounded-xl border border-slate-200 hover:border-green-300 hover:bg-green-50 transition-colors text-left">
              ...
              <p className="font-medium text-slate-900">Add Staff</p>
              <p className="text-xs text-slate-500 mt-1">Register new employee</p>
            </button>
            <button className="p-4 rounded-xl border border-slate-200 hover:border-purple-300 hover:bg-purple-50 transition-colors text-left">
